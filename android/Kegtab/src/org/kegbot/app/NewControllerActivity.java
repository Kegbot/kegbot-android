...
public class NewControllerActivity extends Activity {
  ...
  @InjectView(R.id.new_controller_title) TextView mTitle;
  @InjectView(R.id.new_controller_subtitle) TextView mSubtitle;
  @InjectView(R.id.new_controller_progbar) ProgressBar mProgressBar;
  @InjectView(R.id.new_controller_cancel_button) Button mCancelButton;
  @InjectView(R.id.new_controller_add_button) Button mAssignButton;
  @InjectView(R.id.new_controller_num_meters_group) ViewGroup mNumMetersGroup;
  @InjectView(R.id.new_controller_num_meters) NumberPicker mNumMeters;
